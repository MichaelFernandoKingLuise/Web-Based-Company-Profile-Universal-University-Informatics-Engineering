...
<div class="container-fluid container-inputhomepage">
    <form method="POST" action="admin.php?page=inputpengumumanaksi" enctype="multipart/form-data">
        <div class="form-row">
            <div class="col-md-12">
                <div class="form-group">
                    <label>Input isi Pengumuman: </label>
                    <br>
                    <textarea name="isi_pengumuman" cols="169" rows="20"></textarea>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="form-row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <br>
                    <textarea name="judul_pengumuman" cols="169" rows="3"></textarea>
                </div>
            </div>
        </div>
        <br>
