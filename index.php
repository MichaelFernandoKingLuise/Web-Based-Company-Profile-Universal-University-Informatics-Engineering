...
<head>
    ...
    <style>
        @media (min-width: 0px) and (max-width: 621.98px) {
            .navbar {
                margin: 0 !important;
        ...
        <div class="container-fluid">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><a href="index.php" id="judulCanvas">
                    ...
                    <ul class="navbar-nav pe-3">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu p-2">
                                <li><a class="dropdown-item" href="index.php?page=tentangkami">Tentang Kami</a></li>
                                ...
                                <li><a class="dropdown-item" href="index.php?page=kurikulum">Kurikulum</a></li>
                                <li><a class="dropdown-item" href="index.php?page=karir">Karir</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu p-2">
                                ...
                                <li><a class="dropdown-item" href="index.php?page=karyailmiah">Karya Ilmiah</a></li>
                                <li><a class="dropdown-item" href="index.php?page=prestasi">Prestasi</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="http://uvers.ac.id/" class="btn btn-light" id="ad-mini">Admisi</a>
                        </li>
                    </ul>
                </div>
            </div>
            <!-- BUTTON ADMISI -->
            <a href="http://uvers.ac.id/" class="btn btn-light" id="admisi">Admisi</a>
    ...
    <footer>
        <div class="container-fluid footer" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="100"
            ...
            <div class="footer-wrapper">
                ...
                <a class="nav-link mx-lg-2" id="login" href="index.php?page=login"
                    style="position: absolute; color: #61B5E6 !important;">Login
                </a>
            </div>
        </div>
    </footer>
