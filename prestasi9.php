...
<div class="container-fluid container-kartu1">
    <div class="kartu1-wrapper">
        ...
        $id = $_GET['id'];
        $sql = mysqli_query($db, "SELECT * FROM tbl_prestasi WHERE id_prestasi = $id LIMIT 1;");
        $no = 1;
        while ($rdata = mysqli_fetch_array($sql)) {
            ...
            <div class="tanggal">
                ...
                <i class="fa fa-tags"><a href="index.php?page=prestasi#container-prestasi">Prestasi</a></i>
            </div>
            <?php
            $no++;
        }
