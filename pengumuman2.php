...
<div class="container-fluid container-kartu1">
    <div class="kartu1-wrapper">
        ...
        $id = $_GET['id'];
        $sql = mysqli_query($db, "SELECT * FROM tbl_pengumuman WHERE id_pengumuman = $id LIMIT 1;");
        $no = 1;
        while ($rdata = mysqli_fetch_array($sql)) {
            ...
            <div class="gambar-kartu-wrapper">
                <div class="gambar-kartu">
                    <?php echo "<img src='images/$rdata[gambar_pengumuman]' alt='Gambar Pengumuman'>" ?>
                </div>
            </div>
            ...
            <div class="tanggal">
                ...
                <i class="fa fa-tags"><a href="index.php?page=pengumuman#container-pengumuman">Pengumuman</a></i>
            </div>
            <?php
            $no++;
        }
