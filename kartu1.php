...
<div class="container-fluid container-kartu1">
    <div class="kartu1-wrapper">
        ...
        $id = $_GET['id'];
        $sql = mysqli_query($db, "SELECT * FROM tbl_terkini WHERE id_terkini = $id LIMIT 1;");
        $no = 1;
        while ($rdata = mysqli_fetch_array($sql)) {
            ...
            <div class="gambar-kartu-wrapper">
                <div class="gambar-kartu">
                    <?php echo "<img src='images/$rdata[gambar_terkini]' alt='Gambar Terkini $no'>" ?>
                </div>
            </div>
            ...
            <div class="tanggal">
                <i class="fa fa-calendar"><time><?php echo "$rdata[tanggal_terkini]"; ?></time></i>
                <i class="fa fa-tags"><a href="index.php#content-tengah">Terkini</a></i>
            </div>
            <?php
            $no++;
        }
